...
// Kiểm tra và include các file chức năng
if (file_exists("function/login.php")) {
    include("function/login.php");
} else {
    die("Error: File 'function/login.php' not found.");
}

if (file_exists("function/customer_signup.php")) {
    include("function/customer_signup.php");
} else {
    die("Error: File 'function/customer_signup.php' not found.");
}
?>
<!DOCTYPE html>
<html>
...
<div id="container">
    ...
    <div id="content">
        <div id="product" style="position:relative; margin-top:30%;">
            ...
            <br />
            <?php
            $query = $conn->query("SELECT * FROM product WHERE category='feature' ORDER BY product_id DESC") or die($conn->error);
            while ($fetch = $query->fetch_array()) {
                $pid = $fetch['product_id'];
                $query1 = $conn->query("SELECT * FROM stock WHERE product_id = '$pid'") or die($conn->error);
